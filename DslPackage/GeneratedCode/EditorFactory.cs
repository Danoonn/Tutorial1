...
namespace Company.Tutorial1
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.Tutorial1EditorFactoryId)]
	internal partial class Tutorial1EditorFactory : Tutorial1EditorFactoryBase
	{
		/// <summary>
		/// Constructs a new Tutorial1EditorFactory.
		/// </summary>
		public Tutorial1EditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class Tutorial1EditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected Tutorial1EditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new Tutorial1DocData(this.ServiceProvider, typeof(Tutorial1EditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new Tutorial1DocView(docData, this.ServiceProvider);
		}
	}
}
