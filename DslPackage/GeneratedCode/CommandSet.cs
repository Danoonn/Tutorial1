...
namespace Company.Tutorial1
{
	...
	/// </summary>
	internal partial class Tutorial1CommandSet : Tutorial1CommandSetBase
	{
		/// <summary>
		/// Constructs a new Tutorial1CommandSet.
		/// </summary>
		public Tutorial1CommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class Tutorial1CommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new Tutorial1CommandSetBase.
		/// </summary>
		protected Tutorial1CommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewTutorial1ExplorerCommand,
				typeof(Tutorial1EditorFactory).GUID);
		...
		{
			Tutorial1ExplorerToolWindow explorer = this.Tutorial1ExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected Tutorial1DocData CurrentTutorial1DocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as Tutorial1DocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected Tutorial1DocView CurrentTutorial1DocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as Tutorial1DocView;
			}
		}
		...
		/// </summary>
		protected Tutorial1ExplorerToolWindow Tutorial1ExplorerToolWindow
		{
			get
			{
				Tutorial1ExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(Tutorial1ExplorerToolWindow), true) as Tutorial1ExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				Tutorial1ExplorerToolWindow explorerWindow = this.Tutorial1ExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class Tutorial1ClipboardCommandSet : Tutorial1ClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new Tutorial1ClipboardCommandSet.
		/// </summary>
		public Tutorial1ClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class Tutorial1ClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new Tutorial1ClipboardCommandSetBase.
		/// </summary>
		protected Tutorial1ClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
