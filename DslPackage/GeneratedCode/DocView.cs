...
namespace Company.Tutorial1
{
	...
	/// </summary>
	internal partial class Tutorial1DocView : Tutorial1DocViewBase
	{
		/// <summary>
		/// Constructs a new Tutorial1DocView.
		/// </summary>
		public Tutorial1DocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class Tutorial1DocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new Tutorial1DocView.
		/// </summary>
		protected Tutorial1DocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			Tutorial1DocDataBase docData = this.DocData as Tutorial1DocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for Tutorial1DocViewBase should be an Tutorial1DocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.Tutorial1.Tutorial1Diagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.Tutorial1.Tutorial1Diagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.Tutorial1.Tutorial1ToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.Tutorial1.Tutorial1ToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.Tutorial1DiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.Tutorial1.Tutorial1HelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.Tutorial1.Tutorial1HelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.Tutorial1.Tutorial1HelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
