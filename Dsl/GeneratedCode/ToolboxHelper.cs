...
namespace Company.Tutorial1
{
	...
	/// </remarks>
	public partial class Tutorial1ToolboxHelper : Tutorial1ToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new Tutorial1ToolboxHelper.
		/// </summary>
		public Tutorial1ToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class Tutorial1ToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify Tutorial1 toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "Tutorial1.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify CountryRelationship connector tool.
		/// </summary>
		public const string CountryRelationshipFilterString = "CountryRelationship.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new Tutorial1ToolboxHelperBase.
		/// </summary>
		protected Tutorial1ToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.Tutorial1.Tutorial1DomainModel.SingletonResourceManager.GetString("Tutorial1ToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.Tutorial1.Tutorial1DomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Company.Tutorial1.CountryshapeToolboxItem":
					// Add Countryshape shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.Tutorial1.CountryshapeToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Company.Tutorial1.Tutorial1ToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Tutorial1ToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::Company.Tutorial1.Country.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.Tutorial1.CountryRelationshipToolboxItem":

					// Add CountryRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.Tutorial1.CountryRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("CountryRelationshipToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("CountryRelationshipToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.				
						"Company.Tutorial1.Tutorial1ToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Tutorial1ToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"ConnectExampleRelationF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("CountryRelationshipToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						null, // Connector toolbox items do not have an underlying data object.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require), 
							new global::System.ComponentModel.ToolboxItemFilterAttribute(CountryRelationshipFilterString)
						});
					break;
				case "Company.Tutorial1.CityShapeToolboxItem":
					// Add CityShape shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.Tutorial1.CityShapeToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::Company.Tutorial1.City.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.Tutorial1.CityRelationshipToolboxItem":

					// Add CityRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.Tutorial1.CityRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.Tutorial1.Tutorial1DomainModel));
