...
namespace Company.Tutorial1
{
	...
	public static partial class CountryReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Company.Tutorial1.Country)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.Tutorial1.Country)
				{
					if (candidateTarget is global::Company.Tutorial1.Country)
					{
						global::Company.Tutorial1.Country sourceCountry = (global::Company.Tutorial1.Country)candidateSource;
						global::Company.Tutorial1.Country targetCountry = (global::Company.Tutorial1.Country)candidateTarget;
						if(targetCountry == null || sourceCountry == null || global::Company.Tutorial1.CountryReferencesTargets.GetLinks(sourceCountry, targetCountry).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Company.Tutorial1.Country)
				{
					if (target is global::Company.Tutorial1.Country)
					{
						global::Company.Tutorial1.Country sourceAccepted = (global::Company.Tutorial1.Country)source;
						global::Company.Tutorial1.Country targetAccepted = (global::Company.Tutorial1.Country)target;
						DslModeling::ElementLink result = new global::Company.Tutorial1.CountryReferencesTargets(sourceAccepted, targetAccepted);
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class CityReferencesTargetCityBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::Company.Tutorial1.City)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.Tutorial1.City)
				{
					if (candidateTarget is global::Company.Tutorial1.City)
					{
						global::Company.Tutorial1.City sourceCity = (global::Company.Tutorial1.City)candidateSource;
						global::Company.Tutorial1.City targetCity = (global::Company.Tutorial1.City)candidateTarget;
						if(targetCity == null || sourceCity == null || global::Company.Tutorial1.CityReferencesTargetCity.GetLinks(sourceCity, targetCity).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::Company.Tutorial1.City)
				{
					if (target is global::Company.Tutorial1.City)
					{
						global::Company.Tutorial1.City sourceAccepted = (global::Company.Tutorial1.City)source;
						global::Company.Tutorial1.City targetAccepted = (global::Company.Tutorial1.City)target;
						DslModeling::ElementLink result = new global::Company.Tutorial1.CityReferencesTargetCity(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	/// </summary>
	internal partial class CountryRelationshipConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new CountryRelationshipConnectAction for the given Diagram.
		/// </summary>
		public CountryRelationshipConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the CountryRelationshipConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new CountryRelationshipConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class CountryRelationshipConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the CountryRelationshipConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected CountryRelationshipConnectionTypeBase() : base() {}
		...
		private partial class CountryRelationshipConnectionType : CountryRelationshipConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the CountryRelationshipConnectionType with the given ConnectionBuilder.
			/// </summary>
			public CountryRelationshipConnectionType() : base() {}
		}
	}
