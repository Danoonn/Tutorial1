...
namespace Company.Tutorial1
{
	...
	/// </remarks>
	public partial class Tutorial1HelpKeywordHelper : Tutorial1HelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new Tutorial1HelpKeywordHelper.
		/// </summary>
		protected Tutorial1HelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the Tutorial1HelpKeywordHelper.
		/// </summary>
		public static Tutorial1HelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class Tutorial1HelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new Tutorial1HelpKeywordHelperBase.
		/// </summary>
		protected Tutorial1HelpKeywordHelperBase()
			: base() { }
